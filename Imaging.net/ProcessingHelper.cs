    ...
    public static partial class ProcessingHelper
    {
            ...
            ProcessImageFrameDelegate processor)
        {
            ...
            if (sourceImageData.RawFormat.Equals(ImageFormat.Gif) && destinationFormat.Equals(ImageFormat.Gif))
            {
                ...
                byte[] pallette = sourceImageData.GetPropertyItem((int)Imaging.net.ExifPropertyTag.PropertyTagGlobalPalette).Value;
                int transparentColorIndex = -1;
                Color transparentColor = Color.Empty;
                try
                {
                    transparentColorIndex = sourceImageData.GetPropertyItem((int)Imaging.net.ExifPropertyTag.PropertyTagIndexTransparent).Value[0];
