...
namespace Imaging.net.Encoders
{
    public static class JpegEncoder
    {
        ...
        public static unsafe void EncodeImageWithLibjpeg(Image image, string filePath, float quality, float smooth = 0f, bool progressive = true, bool optimize = true, ProgressDelegate progress = null)
        {
            try
            {
